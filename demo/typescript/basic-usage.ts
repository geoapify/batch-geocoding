/**
 * Basic TypeScript Example - Batch Geocoding
 * 
...
import { Batcher, GeocodingResult, ReverseGeocodingResult, JobStatus } from '../../dist';
import TEST_API_KEY from '../../env-variables';

async function runDemo(): Promise<void> {
    console.log('🚀 Batch Geocoding TypeScript Demo\n');
...
async function forwardGeocodingExample(): Promise<void> {
    ...
    job.onProgress((status: JobStatus) => {
...
async function reverseGeocodingExample(): Promise<void> {
...
async function customBaseUrlExample(): Promise<void> {
